...
export const DadoContext = createContext({});
...
export const DadoProvider = ({children}) => {
  ...
  const getDados = async () => {
    try {
      ...
      console.log('Dados buscados vai API');
      ...
      response.data.documents.map((d)=>{
        let k = d.name.split('projects/pdmapp-f87c4/databases/(default)/documents/notas/',
        );
        data.push({
